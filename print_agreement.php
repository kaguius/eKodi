			...
			<div id="page">
				<div id="content">
					...
					<table border="0" width="100%">
						<tr>
							<td valign="top">
								<p><font face="verdana" size="2">Signed by the Landlord:<br />
								<font face="verdana" size="2">Name: <strong><?php echo $property_manager_name ?></strong><br />
								<font face="verdana" size="2">Phone No: <strong><?php echo $property_manager_phone ?></strong><br />
								<font face="verdana" size="2">Date: <strong><?php echo $date_transactiontime ?></strong>
								</p>
							</td>
							<td>
								<p><font face="verdana" size="2">Signed by the Tenant:<br />

								<font face="verdana" size="2">Name: <strong><?php echo $tenant_name ?></strong><br />
								<font face="verdana" size="2">ID No: <strong><?php echo $id_number ?></strong><br />
								<font face="verdana" size="2">Phone No: <strong><?php echo $phone_number ?></strong><br />
								<font face="verdana" size="2">Date: <strong><?php echo $date_transactiontime ?></strong>
								</p>
							</td>
						</tr>
