	...
	if($adminstatus == 3){
			...
			<div id="content">
				<div class="post">
					<h2><?php echo $page_title ?> | e-kodi</h2>
						...
						<form id="frmDeptCategories" name="frmDeptCategories" method="GET" action="water_tenant_listings.php">
		...
		<?php
			if (!empty($_POST)) {
				...
				?>
				<script type="text/javascript">
						document.location = "water_tenant_listings.php?property_name="<?php.$property_name?>";
				</script>
				<?php
				//header("Location:tenant_listings.php?property_name=".$property_name);
				//die();
			}
	}
